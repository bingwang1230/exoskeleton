...
> 最后更新：2026-09-21（**开课**：ch01 范式转变，出差学习包——用户出差碎片自学，掌握度待自测后记）
...
| 概念 | 掌握度 | 笔记 |
|---|---|---|
| task-specific（离散任务分类+HIL）vs task-agnostic（连续估计）的边界与动机 | 0.0 | notes/ch01_范式转变.md（09-21） |
| 「生物关节力矩估计」作为统一控制信号的论证链 | 0.0 | notes/ch01_范式转变.md（09-21） |
| roadmap 三大未决挑战（优化/安全/数据负担） | 0.0 | notes/ch01_范式转变.md（09-21） |

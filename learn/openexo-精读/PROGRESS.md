...
> 最后更新：2026-09-07（第六章过半：步态相位估计 0.7、髋样条控制器 0.65——四参数三层压缩+84% 最晚出发时间；配图讲解协议上线，正文图入 materials/figures/；下一概念：踝 PJMC，P1 主控制器）
...
| 髋样条控制器（84% 相位偏移的动机） | 0.65 | notes/ch06_髋样条控制器.md |
